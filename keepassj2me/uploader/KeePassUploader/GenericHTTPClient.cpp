...
BOOL GenericHTTPClient::RequestGet(LPCTSTR szURI){
	...
	_hHTTPRequest=::HttpOpenRequest(	_hHTTPConnection,
															...
															INTERNET_FLAG_KEEP_CONNECTION | INTERNET_FLAG_NO_CACHE_WRITE | INTERNET_FLAG_SECURE,
...
BOOL GenericHTTPClient::RequestPost(LPCTSTR szURI){
	...
	_hHTTPRequest=::HttpOpenRequest(	_hHTTPConnection,
															...
															"", // Reference
															&szAcceptType, // Accept Type
															INTERNET_FLAG_KEEP_CONNECTION | INTERNET_FLAG_NO_CACHE_WRITE | INTERNET_FLAG_FORMS_SUBMIT | INTERNET_FLAG_SECURE | INTERNET_FLAG_IGNORE_CERT_CN_INVALID | SECURITY_FLAG_IGNORE_UNKNOWN_CA,
															0); // context call-back point
	...
	MessageBox(NULL, szPostArguments, 0, 0);
